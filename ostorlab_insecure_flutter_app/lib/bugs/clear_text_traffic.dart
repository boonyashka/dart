...
class ClearTextTraffic extends BugRule {
  ...
  /// Trigger the [BugRule]
  @override
    // SECURITY REVIEW [ClearTextTraffic.run -> cleartext HTTP with user-controlled host]:
    // Finding: HTTP request is sent over cleartext HTTP to a user-controlled host.
    // Detection: Taint.
