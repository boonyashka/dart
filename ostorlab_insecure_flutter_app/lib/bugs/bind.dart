...
class BindRule extends BugRule {
  ...
  @override
  // SECURITY REVIEW [BindRule.run -> user-controlled port binding]:
  // Finding: User-controlled input is parsed as a port number and used to bind an HTTP server.
  // Detection: Taint.
  // Threat IDs: DF-1-T, DF-1-D #R+
  // Verdict: approve.
