...
class Provider {
  ...
  // SECURITY REVIEW [Provider.openFile -> file access without validation]:
  // Finding: Opens a file in read mode from a caller-provided path with no validation of the final resolved path.
  // Detection: DFG.
  // Threat IDs: DF-3-I #R+
  // Verdict: approve.
