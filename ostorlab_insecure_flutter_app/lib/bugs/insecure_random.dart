...
class InsecureRandom extends BugRule {
  ...
  Future<void> run(String input) async {
    ...
    // SECURITY REVIEW [InsecureRandom.run -> predictable PRNG with hardcoded seed]:
    // Finding: `Random(SEED)` creates a pseudo-random number generator initialized with a hardcoded, constant seed value.
